...
let valorX = 10;
let valorY = 33;
let resultado = sum(valorX, valorY);

console.log(`A soma de ${valorX} e ${valorY} é igual a ${resultado}.`);
...
console.log(multiplication(7, 4));
console.log(division(34, 3));
console.log(mod(45, 5));
